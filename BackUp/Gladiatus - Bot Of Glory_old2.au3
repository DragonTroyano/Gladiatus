...
Func Lochy1Rzym()
	...
	If $DungeonTryb = 0 Then
		Local $Boss
		If $DungeonQuests[0] = 0 Then _IENavigate($oIE, "javascript" & Chr(0x3a) & "startFight('1', '"&$DungeonID&"')", 0)
		If $DungeonQuests[1] = 0 Then _IENavigate($oIE, "javascript" & Chr(0x3a) & "startFight('3', '"&$DungeonID&"')", 0)
		For $i = 0 to 1
			If $DungeonQuests[$i] = 0 Then ExitLoop
			If $i = 1 Then _IENavigate($oIE, "javascript" & Chr(0x3a) & "startFight('5', '"&$DungeonID&"')", 0)
		Next
	EndIf
EndFunc
#EndRegion
