...
For $i = 1 To 40
	GUICtrlCreateListViewItem("1|21:45:02 24/09/2014|Germania|Jaskiniowa Œwi¹tynia|Szczur|+"&Random(0, 300, 1)&"|+"&Random(1, 5, 1)&"|"&Random(100, 350, 1)&"|"&Random(0, 99, 1)&"|Zwyciêstwo", $ExpeditionsList)
Next
